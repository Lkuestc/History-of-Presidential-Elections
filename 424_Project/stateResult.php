	    	...
	    	<div class="container">
				<div class="row">
					<div class="col-lg-8 col-lg-offset-2">
						...
						<p class="single-query-detail">
							<?php
								$state = $_POST["state-president-query"];
				...
				<div class="row">
					<?php
                        ...
                        // $sql = "select * from PED where winner=1 and home_state='" . $_POST['state-president-query'] . "'";

                        $sql =
                        "
                        	select can.name, elec.year, can.home_state, party.party_name, 
							...
							where elec.winner=can.name and can.home_state='" . $_POST['state-president-query'] . "'
							    and can.CID=rep.CID and elec.year=rep.year and rep.party_ID=party.party_ID
							    and can.CID=g.CID and elec.year=g.year and g.count_ID=c.count_ID
